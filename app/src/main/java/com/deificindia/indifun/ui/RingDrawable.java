...
public class RingDrawable extends Drawable {
     ...
     */
    RingDrawable(int ringWidth, float circleScale, int outlineColor, int ringColor, int centerColor) {
        this.progress = 0;
    ...
    public static class Builder {
         ...
         */
        public RingDrawable create() {
            return new RingDrawable(ringWidth, circleScale, outlineColor, ringColor, centerColor);
        }
