...
public final class CrashActivity {
    ...
    private static final String EXTRA_CONFIG = "com.deificindia.indifun.EXTRA_CONFIG";
    private static final String EXTRA_STACK_TRACE = "com.deificindia.indifun.EXTRA_STACK_TRACE";
    private static final String EXTRA_ACTIVITY_LOG = "com.deificindia.indifun.EXTRA_ACTIVITY_LOG";

    //General constants
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "com.deificindia.indifun.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "com.deificindia.indifun.RESTART";
    private static final String CRASH_HANDLER_PACKAGE_NAME = "com.deificindia.indifun.";
