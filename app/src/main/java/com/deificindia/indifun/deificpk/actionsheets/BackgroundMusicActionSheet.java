...
import com.deificindia.indifun.deificpk.utils.Global;
...
recyclerView.setBackgroundColor(getRandomColorCode());
    ...
    private class BgMusicAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            bgMusicViewHolder.setMusicInfo(info.getMusic_name(), info.getSinger());
    ...
    private class BgMusicViewHolder extends RecyclerView.ViewHolder {
        ...
        BgMusicViewHolder(@NonNull View itemView) {
            ...
            //barVisualizer = itemView.findViewById(R.id.musicvisualizer);
            ...
            itemView.setOnClickListener(view -> {
                if (mPosition == mSelected) {
                    ...
                    if (mListener != null) {
                        mListener.onActionSheetMusicSelected(mPosition, info.getMusic_name(), info.getUrl());
                    }
                }
        ...
        void setPlaying(boolean isPlaying) {
            ...
            /*if(!isPlaying) {
                ...
                int session_id = application().config().audiosessionid;
                if(session_id!=-1){
                    barVisualizer.setAudioSessionId(session_id);
                }
            }*/
        }
    }
